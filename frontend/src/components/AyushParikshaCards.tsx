    ...
    <div className="w-full max-w-5xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        >
          <div className="text-left">
            <span>
              {activeDeckIndex === cardsDeck.length - 1
